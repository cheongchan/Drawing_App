...
class DrawsControllerTest < ActionController::TestCase
  ...
  test "should create draw" do
    assert_difference('Draw.count') do
      post :create, draw: { drawing_url: @draw.drawing_url, privacy: @draw.privacy, views: @draw.views }
    end
  ...
  test "should update draw" do
    patch :update, id: @draw, draw: { drawing_url: @draw.drawing_url, privacy: @draw.privacy, views: @draw.views }
    assert_redirected_to draw_path(assigns(:draw))
  end
